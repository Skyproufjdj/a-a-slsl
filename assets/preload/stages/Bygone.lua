...
--Smol Hypno
makeLuaSprite('bgClouds1', 'backgrounds/Bygone Purpose/BG1 Clouds', -100, -150)
    addLuaSprite('bgClouds1',false)
    setGraphicSize('bgClouds1', getProperty('bgClouds1.width') * 1.0)

makeLuaSprite('bgMoon1', 'backgrounds/Bygone Purpose/BG1 Moon', -550, -350)
    addLuaSprite('bgMoon1',false)
    setGraphicSize('bgMoon1', getProperty('bgMoon1.width') *1.0)

    makeLuaSprite('bg1', 'backgrounds/Bygone Purpose/BG1 Buildings', -100, -150)
    addLuaSprite('bg1',false)
    setGraphicSize('bg1', getProperty('bg1.width') * 1.0)

makeLuaSprite('Rope1', 'backgrounds/Bygone Purpose/BridgeRope', 275, -50)
    addLuaSprite('Rope1',false)
    setGraphicSize('Rope1', getProperty('Rope1.width') * 1.0)

makeLuaSprite('Bridge', 'backgrounds/Bygone Purpose/Bridge', -150, -25)
    addLuaSprite('Bridge',true)
    setGraphicSize('Bridge', getProperty('Bridge.width') * 1.0)

--Big Hypno
    makeLuaSprite('bgClouds2', 'backgrounds/Bygone Purpose/BG2 Sky', -100, -150)
    ...
    makeLuaSprite('bg2', 'backgrounds/Bygone Purpose/BG2 Buildings', -100, -150)
    addLuaSprite('bg2',false)
    setGraphicSize('bg2', getProperty('bg2.width') * 1.0)
    setProperty('bg2.visible', true)
    setProperty('bg2.alpha', 0)

    makeLuaSprite('Bridge2', 'backgrounds/Bygone Purpose/Bridge2', -150, -25)
    ...
    makeLuaSprite('Rope2', 'backgrounds/Bygone Purpose/BridgeRope2', 275, -50)
    ...
    makeLuaSprite('H', 'backgrounds/Bygone Purpose/BigHypno', 600, 100)
...
--Transition
	makeLuaSprite('Trans', 'backgrounds/Bygone Purpose/AlexisTransition', 300, 0)
