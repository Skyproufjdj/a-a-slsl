function onCreate()
	makeLuaSprite('BG_shitno', 'backgrounds/shitty-cave/BG_shitno', -20, 0);
...
function onCreatePost()
	...
	makeLuaText("message", "", 1200, 30, 50)
	setTextAlignment("message", "Right")
	addLuaText("message")
	setTextFont('message', '');       
	makeLuaText("engineText", "", 1200, 30, -1300)
...
function onStepHit()
	if curStep == 2078 then
		makeAnimatedLuaSprite('shitno_pokeball','backgrounds/shitty-cave/shitno_pokeball',1000,780)
